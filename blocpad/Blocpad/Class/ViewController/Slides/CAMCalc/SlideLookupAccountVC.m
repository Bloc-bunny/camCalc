...
static NSString* kASPPriceLookupURL = @"http://celgenecamcalculator.s3.amazonaws.com/asp-price.js";
...
- (void)viewDidLoad
{
    ...
    [DataModel sharedInstance].contract.aspPrice = 899.98;
...
//            NSString *sql = @"UPDATE calculation set vialPrice=?;";
//            BOOL success = [[SQLiteDB sharedConnection] executeUpdate:sql,
//                            [NSNumber numberWithDouble:aspPrice]
//                       ];
